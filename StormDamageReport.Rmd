...
The raw event types include `r sum (is.na (toOfficial))` values that aren't converted, mostly for unofficial events (daily summaries, etc.). For the present analysis we ignore those events.
